...
public class MyReportAction {
	...
	public String share() throws IOException, ClassNotFoundException{
		...
		ReportVO vo = fs.readReport(this.reportId, false, 1);
		vo.setShare("y");
		fs.updateReport(vo, false, 1);
		return null;
	}
	...
	public String tree() throws IOException, ClassNotFoundException{
		...
		List<ReportVO> ls = fs.listReport("true".equalsIgnoreCase(view), userId, auth, 1);
		Collections.sort(ls);
		//转成json
		...
		if("true".equalsIgnoreCase(view)){
			List<ReportVO> sharels = fs.listShareReport(1);
	...
	public String delete(){
		FileService fs = new FileService(VDOPUtils.getServletContext());
		fs.deleteReport(this.reportId, "true".equalsIgnoreCase(view), 1);
		return null;
	}
	...
	public String rename() throws IOException, ClassNotFoundException{
		...
		fs.updateReport(rvo, "true".equalsIgnoreCase(view), 1);
		return null;
	}
